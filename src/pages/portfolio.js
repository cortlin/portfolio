...
export const Portfolio = () => {
  ...
  return (
    <article className='max-w-4xl mx-auto'>
      <h1 className='text-center font-mono text-5xl py-10 mb-4'>Portfolio</h1>

      <section>
        <h2 className='text-3xl font-bold mb-10'>Specialty Manufacturing Quality Control QR Code Scanner</h2>
