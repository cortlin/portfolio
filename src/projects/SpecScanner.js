...
export const SpecScanner = () => {
  ...
  return (
    <article className='max-w-4xl mx-auto mt-20'>
        ...
        <p>I created a Web application that allows us to upload the newest batch of QR codes into a database. This database will be the single source of truth for the current batch of qr codes, as well as a history of all previous qr codes.</p>
